...
class objective(object):
    ...
    def __call__(self, trial):
        ...
        f_text_file   = 'HALOS_NN_%d.txt'%(trial.number)
        f_best_model  = 'HALOS_NN_%d.pt'%(trial.number)
...
n_min = 3               # Minimum number of neurons in hidden layers
n_max = 300             # Maximum number of neurons in hidden layers
min_layers = 1          # Minimum number of hidden layers
max_layers = 10         # Maximum number of hidden layers

# Optuna Parameters
n_trials   = 1000 
study_name = 'Halos_NN_params'
n_jobs     = 1
